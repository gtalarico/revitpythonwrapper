# -*- coding: utf-8 -*-
#
# revitpythonwrapper documentation build configuration file, created by
...
#
# html_title = 'revitpythonwrapper v0.0.0'
...
htmlhelp_basename = 'revitpythonwrapperdoc'
...
latex_documents = [
    (master_doc, 'revitpythonwrapper.tex', 'revitpythonwrapper Documentation',
     'Gui Talarico', 'manual'),
]
...
man_pages = [
    (master_doc, 'revitpythonwrapper', 'revitpythonwrapper Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'revitpythonwrapper', 'revitpythonwrapper Documentation',
     author, 'revitpythonwrapper', 'One line description of project.',
     'Miscellaneous'),
]
